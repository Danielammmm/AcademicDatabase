...
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ('sR3tGvY7', 'Emma', 'EmWr1', 'Wright', 'Smith');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ('uP2iJkO9', 'Liam', 'LiSc2', 'Scott', 'Johnson');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ('hL8mNpX6', 'Olivia', 'OlHi3', 'Hill', 'Williams');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ('aW1oFzQ4', 'Noah', 'NoCo4', 'Cooper', 'Jones');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ('dI5gHuT2', 'Ava', 'AvKi5', 'King', 'Brown');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'rE6sVxY3', 'Isabella', 'IsGr6', 'Green', 'Davis');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'nO9cMwZ8', 'Sophia', 'SoEv7', 'Evans', 'Miller');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'bA4jLpQ7', 'Jackson', 'JaBa8', 'Baker', 'Wilson');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'cE2rTkU9', 'Aiden', 'AiAd9', 'Adams', 'Moore');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'gI7dFvX3', 'Lucas', 'LuNe10', 'Nelson', 'Taylor');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'tO8nRmZ5', 'Mia', 'MiHa11', 'Hall', 'Anderson');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'pU1kYsH6', 'Ella', 'ElRi12', 'Rivera', 'Thomas');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'kA3jXuP8', 'Grayson', 'GrCa13', 'Campbell', 'Jackson');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'mI5tQwE2', 'Aria', 'ArMi14', 'Mitchell', 'White');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'lO4sVzG7', 'Caden', 'CaCa15', 'Carter', 'Harris');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'eU6rWxI3', 'Oliver', 'OlRo16', 'Roberts', 'Martin');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'hA9jKpQ4', 'Elijah', 'ElGo17', 'Gomez', 'Thompson');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'cO2gVzR5', 'Amelia', 'HaPh18', 'Phillips', 'Garcia');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'mY7sHuT1', 'Harper', 'MiDi19', 'Diaz', 'Martinez');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'wI4oNpX8', 'Mila', 'LiTu20', 'Hayes', 'Robinson');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'zE1iFvY9', 'Liam', 'JaPa21', 'Turner', 'Clark');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'qU5pKmO3', 'James', 'ChCr22', 'Parker', 'Rodriguez');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'xO8nRbA2', 'Charlotte', 'AiEd23', 'Cruz', 'Lewis');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'fI6hZwY7', 'Aiden', 'AbCo24', 'Edwards', 'Lee');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'jA3lUkP9', 'Abigail', 'EtHa25', 'Collins', 'Walker');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'lE2oQvX4', 'Ethan', 'EvTu26', 'Stewart', 'Hall');
insert into Estudiante ( Codigo_Seguridad, Nombre, Codigo_Estudiante, Primer_Apellido, Segundo_Apellido) values ( 'pU9tNwG5', 'Evelyn', 'AlPa27', 'Morris', 'Allen');
...
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion 	)values (	1	,	2,	1 )	;
...
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	4	,	2,	1 )	;
...
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	6	,	2,	1 )	;
...
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	8	,	2,	1 )	;
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	8	,	7,	2 )	;
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	9	,	2,	1 )	;
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	9	,	7,	2 )	;
insert into Seccion(	ID_Curso	,	Cupo,	Numero_Seccion	)values (	10	,	2,	1 )	;
...
---curso 4
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (4,2,1);
---curso 5
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (5,3,1);
---curso 6
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (6,3,1);
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (6,4,1);
---curso 8
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (8,5,1);
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (8,6,1);
---curso 9
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (9,7,1);
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (9,8,1);
---curso 10
insert into Prerrequisito(Curso, Prerrequisito, Estado) values (10,9,1);
